...
def create_user_with_email_password(nome, email, password, tipo):
    ...
    try:
        ...
        print("Usuário salvo com segurança no banco de dados local.")
        return True

    except Exception as e:
        print(f"Ocorreu um erro inesperado durante o cadastro: {e}"); return False

def login_with_email_password(email, password):
    """Valida o login comparando a senha fornecida com o HASH salvo no banco."""
    repo_usuario = UsuarioRepository()
